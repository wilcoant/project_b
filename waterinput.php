...
<html lang="en">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="waterinput.php">Home</a>
          <!-- additional page links for nav bar go here-->
        </nav>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <!-- we can use this if we want to link a " next " button at the bottom of the page<nav>
            <ul class="pager">
              <li><a href="gettingstarted.php">Next</a></li>
            </ul>
          </nav>
        -->
        </div><!-- /.blog-main -->
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          ...
          <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
              <li><a href="waterinput.php">Home</a></li>
